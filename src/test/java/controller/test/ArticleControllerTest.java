...
public class ArticleControllerTest {
    ...
    public void testGetUserInfo() throws Exception {
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/user_info/2");
        mockMvc.perform(mockHttpServletRequestBuilder).andExpect(status().isOk())
                .andDo(print());
    ...
    public void testUpdateUserInfo() throws Exception {
        ...
        userInfo.setId(86);
        userInfo.setEmail("super@163.com");
        userInfo.setPhone("18990010346");
        String requestParam = JSONObject.toJSONString(userInfo);
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.post("/users_info");
        mockMvc.perform(mockHttpServletRequestBuilder.contentType(MediaType.APPLICATION_JSON).content(requestParam)).andExpect(status().isOk())
                .andDo(print());
    }
}