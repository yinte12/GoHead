...
public class JwtUtil {
     ...
     * @throws Exception
     */
    public static String generatorToken() throws Exception {
        long ttlMillis = Constants.JWT_KEEP_TIME;
...
//        Claims c = util.parseToken(ab);//注意：如果jwt已经过期了，这里会抛出jwt过期异常。
//        System.out.println(c.getExpiration());
//        String token = util.updateToken(ab);
//        Claims cl = util.parseToken(token);
